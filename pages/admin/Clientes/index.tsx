...
import { Table,useMantineTheme, Modal,Menu,TextInput, Switch, Group, ActionIcon, Box, Text, Button } from '@mantine/core';
...
const ListaClientes: NextPage = () => {
        const form = useForm({
            ...
            clientes: formList([{nombre: "Manu",
            email: "manu@gmail.com",
            telefono: '+34 622533636', active: false },
            {        nombre: "Gerard",
            email: "gerard@gmail.com",
            telefono: '+34 673323222', active: false },
            {nombre: "Manolo", email: "manolo@gmail.com",
            telefono: '+34 673273277', active: true}, {nombre: "Edu", email: "Edu@gmail.com",
            telefono: '+34 643273277', active: 'true'}]),
            },
        ...
        const fields = form.values.clientes.map((_, index) => (
            ...
            <ActionIcon
                color="red"
                variant="filled"
                onClick={() => form.removeListItem('clientes', index)}
            >
                <Trash size={16} />
            </ActionIcon>
            <Modal
