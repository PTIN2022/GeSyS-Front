     ...
     const validateForm = ()=>{
      ...
      const schema = z.object({
        ...
        cargo: z.enum(["Jefe", "Administrador", "Responsable", "Trabajador"],{
            invalid_type_error: "Elige un cargo valido",
            required_error: "Elige un cargo valido",
          }),
        pasword:z.string(),
        confirmPassword:z.string(),
        });
        /*.refine((data) => data.password === data.confirmPassword, {
            message:"contraseña debe ser igual",
            path:["confirmPassword"],
        });*/
        //const result = schema.safeParse({ password: "asdf", confirm: "qwer" });
